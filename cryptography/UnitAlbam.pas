...
var
  FormAlbam: TFormAlbam;

implementation

{$R *.dfm}

procedure TFormAlbam.Button1Click(Sender: TObject);
...
procedure TFormAlbam.Button2Click(Sender: TObject);
begin
Edit1.Text:='';
end;

procedure TFormAlbam.Button3Click(Sender: TObject);
var i:integer;         resultado:array[1..10] of string;
begin
edit1.Text:='';
//SetLength(resultado, 100);
...
procedure TFormAlbam.Button4Click(Sender: TObject);
begin
Edit2.Text:='';
end;
