...
var
  FormAtbash: TFormAtbash;

implementation

{$R *.dfm}

procedure TFormAtbash.Button1Click(Sender: TObject);
...
procedure TFormAtbash.Button2Click(Sender: TObject);
begin
Edit1.Text:='';
end;

procedure TFormAtbash.Button3Click(Sender: TObject);
var i:integer;         resultado:array[1..10] of string;
begin
edit1.Text:='';
//SetLength(resultado, 100);
...
procedure TFormAtbash.Button4Click(Sender: TObject);
begin
Edit2.Text:='';
end;
